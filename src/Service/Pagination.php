...
class Pagination {
     ...
     *
     * N'oubliez pas de configurer votre fichier services.yaml afin que Symfony sache quelle valeur utiliser
     ...
     *
     * On se sert ici de notre moteur de rendu afin de compiler le template qui se trouve au chemin de notre propriété $templatePath,
     ...
     *
     * Elle se sert de Doctrine pour récupérer le repository qui correspond à l'entité que l'on souhaite paginer
     * (voir la propriété $entityClass) puis elle trouve le nombre total d'enregistrements grâce à la fonction findAll() du repository
     *
    ...
    public function getPages() {
        if(empty($this->entityClass)) {
            // S'il n'y a pas d'entité configurée, on ne peut pas changer le repository, la fonction ne peut donc pas continuer
     ...
     *
     * Elle se sert de Doctrine afin de récupérer le repository pour l'entité spécifiée puis grâce au repository
     * et à sa fonction findBy() on récupère les données dans une certaine limite et en partant d'un offset
     *
